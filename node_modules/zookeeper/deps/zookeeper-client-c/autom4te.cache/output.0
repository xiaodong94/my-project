...
@%:@ Generated by GNU Autoconf 2.69 for zookeeper C client 3.5.8.
@%:@
...
PACKAGE_STRING='zookeeper C client 3.5.8'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures zookeeper C client 3.5.8 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of zookeeper C client 3.5.8:";;
   esac
  cat <<\_ACEOF
...
if $ac_init_version; then
  cat <<\_ACEOF
zookeeper C client configure 3.5.8
...
It was created by zookeeper C client $as_me 3.5.8, which was
...
pkg_failed=no
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for cppunit >= 1.10.2" >&5
$as_echo_n "checking for cppunit >= 1.10.2... " >&6; }
...
ac_log="
This file was extended by zookeeper C client $as_me 3.5.8, which was
generated by GNU Autoconf 2.69.  Invocation command line was
...
ac_cs_version="\\
zookeeper C client config.status 3.5.8
